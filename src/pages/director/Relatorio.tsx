  ...
  return (
    <div className="min-h-full bg-lavo-paper p-6 max-w-md mx-auto">
      ...
      <div className="flex justify-between items-center mb-3">
        <h2 className="font-display text-xs tracking-wide text-lavo-ink">POR MEMBRO</h2>
        <select
          value={sort}
          onChange={(e) => setSort(e.target.value as typeof sort)}
          className="text-xs font-bold px-2 py-1.5 rounded-md border-2 border-lavo-ink bg-white"
        >
      ...
      {loading ? (
        ...
        <p className="text-sm text-lavo-muted text-center py-6">Nenhum membro cadastrado.</p>
      ) : (
        <ul className="space-y-1">
          {summary.memberStats.map((s) => (
            ...
            >
              ...
              <p className="font-display text-sm text-lavo-ink w-12 text-right">
